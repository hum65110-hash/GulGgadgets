      ...
      <section className="flex-1 flex flex-col p-6 lg:p-10">
        ...
        <div className="mb-10 space-y-6">
          ...
          <div className="flex flex-col md:flex-row justify-between gap-4">
            <div>
              <h1 className="text-4xl font-bold text-white">Smartphones</h1>
              <p className="text-text-secondary">
                Showing 245 results for latest mobile devices
              </p>
            </div>
          </div>
        </div>

        <ProductGrid category="smartphones" priceRanges={priceRanges}/>
