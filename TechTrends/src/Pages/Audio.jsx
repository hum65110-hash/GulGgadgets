      ...
      <section className="flex-1 flex flex-col p-6 lg:p-10">
        ...
        <div className="mb-10 space-y-6">
          ...
          <div className="flex flex-col md:flex-row justify-between gap-4">
            <div>
              <h1 className="text-4xl font-bold text-white">Audio Devices</h1>
              <p className="text-text-secondary">
                Showing 189 results for headphones, speakers & more
              </p>
            </div>
          </div>
        </div>

        <ProductGrid category="audio" priceRanges={priceRanges}/>
